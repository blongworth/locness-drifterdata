...
class SpotDataCollector:
    ...
    def __init__(
        ...
        logger.info(f"SpotDataCollector initialized with {collection_interval} minute intervals")
    ...
    def collect_data(self):
        ...
        try:
            ...
            if positions:
                ...
                logger.info(f"Collected {len(positions)} positions, inserted {inserted_count} new records")
                ...
                logger.info(f"Database now contains {stats['total_positions']} total positions "
    ...
    def start(self):
        ...
        self.running = True
        logger.info(f"Data collector started, will collect data every {self.collection_interval} minutes")
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler('spot_collector.log'),
